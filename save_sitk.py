...
def savedicom(outputdir, input,  pixel_dtypes="int16"):
    ...
    # dictionary and not t  he automatically generated information from the file IO
    ...
    list(map(lambda i: writeSlices(series_tag_values, new_img, outputdir, i, writer),
...
#new_arr = np.random.uniform(0, 255, size=(301, 360, 360)).astype(np.int16)
#savedicom(outputdir="test", input=new_arr,  pixel_dtypes="np.int16")
